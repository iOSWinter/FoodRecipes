...
- (void)setPosition:(kMXPageControlPosition)pisition {
    switch (pisition) {
        case kMXPageControlPositionBottom: {
            ...
            self.center = CGPointMake(_scrollViewWidth * 0.5, _scrollViewHeight - self.frame.size.height * 0.5);
        }
            break;
        case kMXPageControlPositionTop: {
            self.frame = CGRectMake(0, 0, _pageControlWidth, kMXPageControlHeight);
            self.center = CGPointMake(_scrollViewWidth * 0.5, self.frame.size.height * 0.5);
        }
            break;
        ...
        case kMXPageControlPositionRight: {
            ...
            break;
        case kMXPageControlPositionLeftBottom: {
            self.frame = CGRectMake(0,
                                    _scrollViewHeight - kMXPageControlHeight,
                                    _pageControlWidth,
                                    kMXPageControlHeight);
            ...
            break;
        case kMXPageControlPositionRightBottom: {
            self.frame = CGRectMake(_scrollViewWidth - _pageControlWidth,
                                    _scrollViewHeight - kMXPageControlHeight,
                                    _pageControlWidth,
                                    kMXPageControlHeight);
        }
